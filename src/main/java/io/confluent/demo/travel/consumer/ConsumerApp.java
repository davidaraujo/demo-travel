package io.confluent.demo.travel.consumer;
...
public class ConsumerApp implements Runnable {
    ...
    public ConsumerApp(String propertiesFile,
                           String topicNames,
                           String groupId,
                           String clientId) {
        try {
    ...
    public void runConsumer() throws IOException {
        ...
        try {
            ...
            logger.info("Starting consumer on ConsumerApp ...");
            while (true) {
                // Consume records
    ...
    public static void main(final String[] args) throws Exception {
        ...
        if (numArgs < 4) {
            ...
            try {
                ...
                ConsumerApp consumer = new ConsumerApp(propertiesFile, topicNames, groupId, clientId);
